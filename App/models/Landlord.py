...
class Landlord(User):
    ...
    listings = db.relationship('Listing', backref='landlord', lazy=True)  # Define the relationship
    ...
    def __init__(self, username, email, password):
        super().__init__(username=username, email=email, password=password, role='landlord')
